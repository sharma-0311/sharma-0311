...
- BCA-AI Student @ Invertis University |  Data Science & ML Enthusiast  
  Bareilly, India | 🌐 [LinkedIn](https://www.linkedin.com/in/raghav--gaur) |  rgour6350@gmail.com  
   [GitHub Portfolio](https://github.com/sharma-0311) | 📱 [Instagram](https://www.instagram.com/sharma.0311_)
...
**Libraries**: Pandas, NumPy, Scikit-learn, TensorFlow, PyTorch, SHAP, Matplotlib, Seaborn  
**Tools**: Power BI, Git, Excel (Advanced), GCP  
**Techniques**: ETL, Feature Engineering, Model Tuning, Explainable AI, Data Visualization  
**Soft Skills**: Problem Solving | Communication | Analytical Thinking | Collaboration
...
⭐ If you like what you see, don’t forget to **star** the repositories and connect!
